...
if __name__ == "__main__":
    ...
    updated_tr_unigrams = get_unknown_ngrams(tr_unigrams_dict, 1, 35)
    updated_tr_bigrams = get_unknown_ngrams(tr_bigrams_dict, 2, 0)
    updated_de_unigrams = get_unknown_ngrams(de_unigrams_dict, 1, 35)
    ...
    print(f'VAL TRUTHFUL UNIGRAM ACCURACY = {check_accuracy(val_tr_uni_preds, val_tr_labels)}')
    tb_tr_count = val_tr_bi_preds.count(0)
    tb_de_count = val_tr_bi_preds.count(1)
    print(f'\nBigrams:\ttruthful = {tb_tr_count}\tdeceptive = {tb_de_count}')
    ...
    print(f'VAL DECEPTIVE UNIGRAM ACCURACY = {check_accuracy(val_de_uni_preds, val_de_labels)}')
    db_tr_count = val_de_bi_preds.count(0)
    db_de_count = val_de_bi_preds.count(1)
    print(f'\nBigrams:\ttruthful = {db_tr_count}\tdeceptive = {db_de_count}')
...
# TESTING **********************************************************************
    ...
    print(f'\nTEST PREDICTIONS ({len(test_uni_preds)}) ******')

...
if __name__ == "__main__":
    ...
    train_truthful = ngrams_model.read_file(train_truthful_path)
    train_deceptive_path = "A1_DATASET//train//deceptive.txt"
    train_deceptive = ngrams_model.read_file(train_deceptive_path)
    # validation data
    validation_truthful_path = "A1_DATASET//validation//truthful.txt"
    validation_truthful = ngrams_model.read_file(validation_truthful_path)
    validation_deceptive_path = "A1_DATASET//validation//deceptive.txt"
    validation_deceptive = ngrams_model.read_file(validation_deceptive_path)
    # test data
    test_path = "A1_DATASET//test//test.txt"
    test = ngrams_model.read_file(test_path)
    ...
    vocabulary_uni_set = ngrams_model.build_uni_vocabulary([train_truthful_tokens, train_deceptive_tokens, validation_truthful_tokens, validation_deceptive_tokens, test_tokens])
    vocabulary_bi_set = ngrams_model.build_bi_vocabulary([train_truthful_tokens, train_deceptive_tokens, validation_truthful_tokens, validation_deceptive_tokens,test_tokens])

    # step 4:
    # calculate truthful_unigram, truthful_bigram, deceptive_unigram, deceptive_bigram from train
    prob_unigram_truthful = ngrams_model.prob_unigram(train_truthful_tokens, vocabulary_uni_set)
    ...
    prob_unigram_deceptive = ngrams_model.prob_unigram(train_deceptive_tokens, vocabulary_uni_set)
    ...
    prob_bigram_truthful = ngrams_model.prob_bigram(train_truthful_tokens, vocabulary_uni_set, vocabulary_bi_set)
    ...
    prob_bigram_deceptive = ngrams_model.prob_bigram(train_deceptive_tokens, vocabulary_uni_set, vocabulary_bi_set)
    ...
    # step 5:
    # handle unknown word
    count_unigram_truthful = ngrams_model.count_unigram(train_truthful_tokens, vocabulary_uni_set)
    count_unigram_truthful, del_keys_truthful = unknown.unknown(count_unigram_truthful, 1) # n = 1

    count_unigram_deceptive = ngrams_model.count_unigram(train_deceptive_tokens, vocabulary_uni_set)
    ...
    train_deceptive_tokens = unknown.unknown_tokens_process(train_truthful_tokens, del_keys_truthful)
    ...
    count_bigram_truthful = ngrams_model.count_bigram(train_truthful_tokens, vocabulary_bi_set)
    ...
    count_bigram_deceptive = ngrams_model.count_bigram(train_deceptive_tokens, vocabulary_bi_set)
    ...
    # step 7: validation data truthful dataset: unigram-> truthful perplexity, deceptive perplexity,
